...
switch(etatActuel) {
case EtatJeu::DEBUT: return "Debut de partie";
case EtatJeu::CHOIX_COULEUR: return "Choix de couleur";
case EtatJeu::TOUR_JOUEUR_JAUNE: return "Tour joueur jaune";
case EtatJeu::TOUR_JOUEUR_ROUGE: return "Tour joueur rouge";
case EtatJeu::FIN_PARTIE: return "Fin de partie";
