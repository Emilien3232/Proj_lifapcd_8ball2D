...
class Jeu {
    ...
    public:
        ...
        void bouletombée(boule &B);
        void bouletombéeBLCH(boule &B); //pour la boule blanche , cas particulier
        bool bouletombéeNR(boule &B); //pour la boule noire , cas particulier
